...
public class LoginController {
  ...
  //로그인화면
  @GetMapping("/login")     //GET http://localhost:9081/login
  ...
  //로그인처리
  @PostMapping("/login")    //POST http://localhost:9081/login
  public String login(
  ...
  //로그 아웃
  @DeleteMapping("logout")      //DELETE http://localhost:9081/logout
  @ResponseBody
